...
.center[
![](https://media2.giphy.com/media/5C472t1RGNuq4/giphy.gif?cid=790b76114b58b79ee92f2fa959969b9d111633782b5a5a7a&rid=giphy.gif)
]
---
...
- **Elasticity/Scalability:**(under constraint of constant / acceptably-increasing request time)
  - can it save more files (scalability) ? Bigger files ?
  - can it process more request ? (elasticity)
  - can I add mode node ? (scalability)

---
# 2. The fundamental problems of distribution

Allways keep in mind those issues :
...
- **Have a master** which organize the work to avoid conflict

- **Asynchron/synchron** nodes can work in an asynchron way, and then synchronize theirs data

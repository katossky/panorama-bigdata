...
3. Restreignez vous aux données de Wikipédiat en français (`wiki=="frwiki"`). Maintenez à jour un fichier CSV, qui donne le nombre d'édition (`type=="edit"`) dans une fenêtre glissante de 5 min heure calculée toutes les 10 secondes

...
.pull-left[
- 1940 - mid 1970 : Mainframe era (still use today)
...
.pull-left[
- mid 1970 - mid-1990 : Fat client era.
...
*srouce : https://leshorizons.net/datacenter/*
...
*srouce : https://www.lebigdata.fr/wp-content/uploads/2018/02/grid-computing-vs-cluster-computing-1.jpg*
...
Virtualized a full OS come with a cost in ressources. Espacially if you want only one specific application (database, python server, R server ...).


--
So instead of virtualize a fullOS, you can create an image with only your app and the needed libraries.
...
- But, because cloud computing become cheaper, more people use it, and are less carful with the cost. So more servers are running, maybe over dimensionned one, and cloud computing can me more polluting than old school datacente (rebound effect).
